...
- **Aula:** Projeto Cordel Moderno
- **Exemplo Prático X:** Este exercício serve de exemplo de um site completo chamado Cordel Moderno.
...
1. Clone este repositório em sua máquina local:
   ...
   ```bash
   git clone https://github.com/MarcusFerreira/projeto-cordel-moderno.git
